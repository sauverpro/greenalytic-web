...
import { exportToPDF, exportToExcel, printVehicles, type Vehicle } from "./ExportUtils"
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      renderCell: (params) => {
        ...
        return (
          <div className={`px-2 py-1 rounded-full text-xs font-semibold ${bgColor} ${textColor}`}>{params.value}</div>
        )
      },
    },
    {
      ...
      renderCell: (params) => (
        <div
          className={`px-2 py-1 rounded-full text-xs font-semibold ${
            params.value === "Personal" ? "bg-blue-100 text-blue-700" : "bg-yellow-100 text-yellow-700"
          }`}
        >
          {params.value}
        </div>
    ...
    },
    {
      ...
      width: 120,
      renderCell: (params) => {
        const bgColor = params.value === "active" ? "bg-green-100" : "bg-red-100"
        const textColor = params.value === "active" ? "text-green-700" : "text-red-700"
  ...
  return (
    <div className="h-full flex flex-1 max-w-[100%]">
      <DataTable
        ...
        searchFields={["model", "licensePlate", "chassisNumber", "owner", "status"]}
