...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Import Prisma client
// Assuming isOTPValid function is in utils

var tokenExpirationTime = 24 * 60 * 60 * 1000; // Token expiration time in milliseconds

var verifyEmail = exports.verifyEmail = (0, _globaleerorshandling.catchAsync)(/*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var token, user, receivedOTP, storedOTP, validOTP;
