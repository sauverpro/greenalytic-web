...
var changepassword = exports.changepassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var _req$body, currentPassword, newPassword, userId, userEmail, user, isPasswordCorrect, hashedPassword;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, currentPassword = _req$body.currentPassword, newPassword = _req$body.newPassword;
          userId = req.userId, userEmail = req.userEmail; // Extract userId and userEmail from request (e.g., from JWT or session)
        ...
        case 10:
          _context.next = 12;
          return (0, _passwordfunctions.passComparer)(currentPassword, user.password);
        case 12:
        ...
        case 23:
          ...
          console.log('Error:', _context.t0.message, _context.t0.name);
          res.status(500).json({
