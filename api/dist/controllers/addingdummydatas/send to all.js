...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // socketServer.js
...
var server = exports.server = _http["default"].createServer();
...
io.on('connection', function (socket) {
  ...
  socket.on('sendData', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
      var type, serialNumber, vehicleId, dataPayload, responseMessage, savedData;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            // Destructure incoming data
            type = data.type, serialNumber = data.serialNumber, vehicleId = data.vehicleId, dataPayload = data.dataPayload;
            responseMessage = '';
            savedData = null; // Based on data type, insert into the appropriate table (EmissionData, FuelData, GPSData)
            if (!(type === 'emission')) {
              _context.next = 12;
              break;
            }
          ...
          case 30:
            ...
            console.error('Error processing data:', _context.t0);
            socket.emit('dataStatus', {
              success: false,
